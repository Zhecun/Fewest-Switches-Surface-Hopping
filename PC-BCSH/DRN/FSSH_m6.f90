module constant
    implicit none
    double precision,parameter :: A=0.03
    double precision,parameter :: B=3.2
    double precision,parameter :: Z=2
    double precision,parameter :: E0=0.01
...
!********************************************************
    ...
    double precision function D_V12(x)
        implicit none
        double precision :: x
        D_V12=A*(-2*B*(x-Z)*exp(-B*(x-Z)**2)-2*B*(x+Z)*exp(-B*(x+Z)**2))
        return
    endfunction
